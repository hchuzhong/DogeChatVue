...
<template>
    <div>
        <div class="h-self-screen bg-blue-100 flex justify-center items-center">
                ...
                <form class="bg-white p-10 rounded-lg shadow-lg min-w-full">
                    ...
                    <div>
                        ...
                        <div class="flex justify-center align-items">
                            ...
                            <button class="ml-2 bg-blue-600 rounded-lg px-4 text-white tracking-wide font-semibold font-sans min-w-[66px]" @click.prevent="sendValidateCode">发送</button>
                        </div>
                    </div>
                    <div>
                    ...
                    <button type="submit" class="w-full mt-6 bg-blue-600 rounded-lg px-4 py-2 text-lg text-white tracking-wide font-semibold font-sans" @click.prevent="submit">确认</button>
                </form>
            </div>
        </div>
    </div>
