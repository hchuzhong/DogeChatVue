    ...
    <div class="w-full flex items-center mb-2" :class="{'flex-row-reverse': isSelf, 'cannotselect': isMobileDevice()}">
        ...
        <div class="flex flex-col mx-1">
            <div class="bg-gray-100 dark:bg-gray-700 rounded px-5 py-2 mt-2 text-gray-700 dark:text-gray-300 relative" :style="maxWidthStyle">
                ...
                <img v-if="messageData.isPicture" class="object-cover rounded cursor-pointer max-w-[300px]" :style="`${messageData.height && `height: ${messageData.height}px; width: ${messageData.width}px`}`" :src="messageData.content" alt="" @click="() => showFullScreenImage(messageData.content)" />
