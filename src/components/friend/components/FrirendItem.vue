...
<template>
    <div>
        <a class="max-h-20 px-3 py-2 cursor-pointer flex items-center text-sm focus:outline-none focus:border-gray-500 transition duration-150 ease-in-out" :class="{'bg-gray-100 dark:bg-gray-600': isChoose && !isMobile, 'hover:bg-gray-100 dark:hover:bg-gray-600': !isChoose && !isMobile}">
